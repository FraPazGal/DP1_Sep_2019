...
//	private ConferenceService		conferenceService;
	...
	public ModelAndView createSponsorship() {
		...
		final SponsorshipForm createSponsorshipFormObject = new SponsorshipForm();
	...
	public ModelAndView newSp(@Valid final SponsorshipForm createSponsorshipFormObject, final BindingResult binding) {
	...
	public ModelAndView edit(@Valid final SponsorshipForm editSponsorshipFormObject, final BindingResult binding) {
		Actor principal;
		ModelAndView res;
		boolean isPrincipal = false;
	...
	protected ModelAndView createEditModelAndView(final SponsorshipForm editSponsorshipFormObject) {
		ModelAndView result;
	...
	protected ModelAndView createEditModelAndView(final SponsorshipForm editSponsorshipFormObject, final String messageCode) {
		ModelAndView result;
	...
	protected ModelAndView createNewModelAndView(final SponsorshipForm createSponsorshipFormObject) {
		ModelAndView result;
	...
	protected ModelAndView createNewModelAndView(final SponsorshipForm createSponsorshipFormObject, final String messageCode) {
		ModelAndView result;
		//Collection<Conference> conferences = this.conferenceService.publishedConferences();
