...
<security:authorize access="hasAnyRole('AUTHOR','REVIEWER','ADMIN')">
	<jstl:choose>
		...
		<jstl:when test="${isPrincipal or isAdmin}">
			<h1>
				<spring:message code="submission.title.display" />
			</h1>
			...
			<h2>
				<spring:message code="submission.title.paper.display" />
			</h2>
			<table class="displayStyle">
				<tr>
					<td><strong> <spring:message
			...
			<jstl:if test="${submission.cameraReadyPaper != null }">
				...
				<h2>
					<spring:message code="submission.title.paper.cameraReady.display" />
				</h2>
				<table class="displayStyle">
					<tr>
						<td><strong> <spring:message
		...
		<jstl:otherwise>
			<p>
				<spring:message code="registration.not.allowed" />
				<br>
			</p>
		</jstl:otherwise>
	</jstl:choose>
